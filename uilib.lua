...
do
    ...
    function Funcs:AddButton(...)
        ...
        Button.Base, Button.Stroke, Button.Corner = CreateButton(Button)
        InitEvents(Button)
    ...
    function Funcs:AddToggle(Idx, Info)
        ...
        -- Add glow effect for active toggle
        local SwitchGlow = New("Frame", {
            AnchorPoint = Vector2.new(0.5, 0.5),
        ...
        function Toggle:Display()
            ...
            -- Handle glow effect
            SwitchGlow.Visible = Toggle.Value and not Toggle.Disabled
            if Toggle.Value then
                TweenService:Create(SwitchGlow, Library.TweenInfo, {
